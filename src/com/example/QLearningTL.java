 ...
 *
 */
public class QLearningTL extends MDPSolver implements QProvider, LearningAgent, Planner{
	 ...
	 */
	public QLearningTL(SADomain domain, double gamma, HashableStateFactory hashingFactory,
